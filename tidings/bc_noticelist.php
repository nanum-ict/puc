...
<body>
    ...
    <main id="content" class="sub tidings"> <!-- 폴더별 class -->
        <section class="sub-content common-list bc-noticelist"> <!-- 페이지명 class -->
                ...
                <div class="table-wrap">
                    <table class="table list-type1">
                        ...
                        <tbody>
                            <tr>
                                <td class="num">10</td>
                                <td class="subject"><a href="/tidings/bc_noticeview.php">포승(2)일반산업단지 지원시설용지 수의계약 공고<i class="icon-floppy"><span class="sr-only">첨부파일</span></i></a></td>
                                <td>평택도시공사</td>
                                <td>2016-04-12</td>
                                <td>354</td>
                            </tr>
