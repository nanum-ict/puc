...
<body>
    ...
    <main id="content" class="sub tidings"> <!-- 폴더별 class -->
        <section class="sub-content common-list breakdown-list"> <!-- 페이지명 class -->
            <div class="section-header">
                ...
                <h4 class="title">수의계약 내역공개</h4>
            </div>
            <div class="section-content">
                <div class="box">
                    <strong>평택도시공사의 수의계약 내역을 공개합니다.</strong>
                    <p>공정한 절차로 선정된 수의계약 내역을 공개하여 믿을 수 있는 평택도시공사가 되겠습니다.</p>
                </div>
                ...
                <div class="table-wrap">
                    <table class="table list-type1">
                        ...
                        <tbody>
                            <tr>
                                <td class="num">10</td>
                                <td class="subject"><a href="/tidings/breakdown_view.php">포승(2)일반산업단지 지원시설용지 수의계약 공고<i class="icon-floppy"><span class="sr-only">첨부파일</span></i></a></td>
                                <td>평택도시공사</td>
                                <td>2016-04-12</td>
                                <td>354</td>
                            </tr>
