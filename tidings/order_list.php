...
<body>
    ...
    <main id="content" class="sub tidings"> <!-- 폴더별 class -->
        <section class="sub-content common-list order-list"> <!-- 페이지명 class -->
            <div class="section-header">
                ...
                <h4 class="title">발주계획</h4>
            </div>
            <div class="section-content">
                <div class="box">
                    <strong>평택도시공사의 발주계획을 공개합니다.</strong>
                    <p>발주계획 공개를 통하여 투명하고 공정한 평택도시공사가 되겠습니다.</p>
                </div>
                ...
                <div class="table-wrap">
                    <table class="table list-type1">
                        ...
                        <tbody>
                            <tr>
                                <td class="num">10</td>
                                <td class="subject"><a href="/tidings/order_view.php">포승(2)일반산업단지 지원시설용지 수의계약 공고<i class="icon-floppy"><span class="sr-only">첨부파일</span></i></a></td>
                                <td>평택도시공사</td>
                                <td>2016-04-12</td>
                                <td>354</td>
                            </tr>
