...
<body>
    ...
    <main id="content" class="sub tidings"> <!-- 폴더별 class -->
        <section class="sub-content common-list notice-list"> <!-- 페이지명 class -->
                    ...
                    <table class="table list-type1">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="subject"><a href="/tidings/notice_view.php">포승(2)일반산업단지 지원시설용지 수의계약 공고<i class="icon-floppy"><span class="sr-only">첨부파일</span></i></a></td>
                                <td>평택도시공사</td>
                                <td>2016-04-12</td>
                                <td>354</td>
                            </tr>
                            ...
                            <tr>
                                <td class="num">9</td>
                                <td class="subject"><a href="/tidings/notice_view.php">포승(2)일반산업단지 지원시설용지 수의계약 공고</a></td>
                                <td>평택도시공사</td>
                                <td>2016-04-12</td>
                                <td>354</td>
                            </tr>
